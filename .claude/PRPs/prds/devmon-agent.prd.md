...
| 7 | Hardening & OSS release | Rate limiting, security review, automated installer, threat-model docs, AGPL-3.0 release | in-progress | - | 6 | [hardening-and-oss-release.plan.md](../plans/hardening-and-oss-release.plan.md) |
