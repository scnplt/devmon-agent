...
| 4 | Logs & live streaming | Historical logs plus a resilient live stream channel | awaiting validation | with 3 | 2 | [logs-and-live-streaming.plan.md](../plans/completed/logs-and-live-streaming.plan.md) · [report](../reports/logs-and-live-streaming-report.md) |
